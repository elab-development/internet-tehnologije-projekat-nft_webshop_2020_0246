...
contract NFTMarketplace is ERC721URIStorage {
    ...
    modifier onlyOwner() {
        require(
            msg.sender == owner,
            "Samo vlasnik moze da promeni listing cenu"
        );
        _;
    }
    ...
    function createMarketItem(uint256 tokenId, uint256 price) private {
        require(price > 0, "Cena mora biti barem 1");
        require(
            msg.value == listingPrice,
            "Cena mora biti ista kao listed cena"
        );
    ...
    function reSellToken(uint256 tokenId, uint256 price) public payable {
        require(
            ...
            "Samo vlasnik moze da pozove ovu akciju"
        );
    ...
    function createMarketSale(uint256 tokenId) public payable {
        ...
        require(
            msg.value == price,
            "Molimo vas unesite predlog cene"
        );
